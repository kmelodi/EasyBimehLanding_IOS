...
@implementation InsurancePolicyPlanController
                ...
                completionBlock:(CompletedGetSpecialPlan) onCompleted
{
    ...
    [_queryBuilder appendString: @"/InsurancePolicyPlan/SpecialPlan"];
    ...
    [[self clientInstance]
     ...
     success: ^(id _context, HttpResponse *_response) {
         ...
         else
         {
             ...
             BaseModelSpecialPlan* _result = (BaseModelSpecialPlan*) [APIHelper jsonDeserialize: _strResult
                toClass: BaseModelSpecialPlan.class];
